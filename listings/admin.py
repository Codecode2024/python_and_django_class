...
from .models import Listing, Subjecct
...
class ListingAdminForm(forms.ModelForm):
    professions = forms.ModelMultipleChoiceField(queryset=Subjecct.objects.all(), widget=FilteredSelectMultiple(verbose_name="professions", is_stacked=False, attrs={'rows': 5}), required=False, label="Select Professions")
...
class SubjecctAdmin(admin.ModelAdmin):
    list_display = 'name',
    search_fields = 'name',

admin.site.register(Listing, ListingAdmin)
admin.site.register(Subjecct, SubjecctAdmin)    